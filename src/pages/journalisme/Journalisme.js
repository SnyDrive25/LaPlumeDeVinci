import '../../App.css';
import './Journalisme.css';

function Journalisme() {

    document.title = "Articles - La Plume De Vinci";
    ...
    function getArticles() {
        base('articles').select({
            ...
            records.forEach(function (record) {
                document.getElementById('articles').innerHTML += "<div class='article' onclick='window.location.href=`../journalisme/" + record.get('url') + "`'>" +
